...
You are the supply chain analytics engineer at a mid-sized consumer goods company. The company operates **3 regional distribution centers (DCs)** with known, fixed daily throughput capacity. These DCs ship product to **5 downstream regional markets**, each served today through a mix of direct trucking lanes.
...
- **Known daily supply capacity** at each of the 3 DCs
